module Ebay # :nodoc:
  module Types # :nodoc:
    class NotificationEventTypeCode
      ...
      OrderInquiryOpened = 'OrderInquiryOpened'
      OrderInquiryReminderForEscalation = 'OrderInquiryReminderForEscalation'
      OrderInquiryProvideShipmentInformation = 'OrderInquiryProvideShipmentInformation'
      OrderInquiryClosed = 'OrderInquiryClosed'
      OrderInquiryEscalatedToCase = 'OrderInquiryEscalatedToCase'
      ItemReadyForPickup = 'ItemReadyForPickup'
      ItemOutOfStock = 'ItemOutOfStock'
      BuyerNoShow = 'BuyerNoShow'
      WebnextMobilePhotoSync = 'WebnextMobilePhotoSync'
