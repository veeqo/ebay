module Ebay # :nodoc:
  module Types # :nodoc:
    class AccountDetailEntryCode
      ...
      UspsLabelFee = 'UspsLabelFee'
      UspsLabelFeeCredit = 'UspsLabelFeeCredit'
      ShippingInsuranceFee = 'ShippingInsuranceFee'
      ShippingInsuranceFeeCredit = 'ShippingInsuranceFeeCredit'
      UspsShortpaidFee = 'UspsShortpaidFee'
      UspsShortpaidFeeCredit = 'UspsShortpaidFeeCredit'
      CoFundingCharge = 'CoFundingCharge'
      CoFundingChargeCredit = 'CoFundingChargeCredit'
      FinalValueFee = 'FinalValueFee'
      FinalValueFeeCredit = 'FinalValueFeeCredit'
      InternationalFee = 'InternationalFee'
      InternationalFeeCredit = 'InternationalFeeCredit'
      FinalValueFeeFixedFeePerOrder = 'FinalValueFeeFixedFeePerOrder'
      FinalValueFeeFixedFeePerOrderCredit = 'FinalValueFeeFixedFeePerOrderCredit'
      FinalValueFeeBelowStandard = 'FinalValueFeeBelowStandard'
      FinalValueFeeBelowStandardCredit = 'FinalValueFeeBelowStandardCredit'
      AdFeeExpress = 'AdFeeExpress'
      AdFeeExpressCredit = 'AdFeeExpressCredit'
      DepositProcessingVariableFee = 'DepositProcessingVariableFee'
      DepositProcessingVariableFeeCredit = 'DepositProcessingVariableFeeCredit'
      DepositProcessingFixedFee = 'DepositProcessingFixedFee'
      DepositProcessingFixedFeeCredit = 'DepositProcessingFixedFeeCredit'
    end
  end
end
